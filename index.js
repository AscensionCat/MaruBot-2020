...
bot.on("message", async msg => {
  ...
  try {
    if (msg.content.startsWith(`${prefix}play`)) {
      ...
      if (!voiceChannel)
        return msg.channel.send("Üzgünüm fakat ses kanalında olmalısın.");
        ...
        try {
          ...
          return msg.channel.send(
            new Discord.MessageEmbed()
              ...
              .addField(
                "Playlist",
                `Playlist: **${playlist.title}** sıraya eklendi`
              )
          );
        } catch (error) {
          try {
              ...
              try {
                ...
                msg.channel.send(
                  new Discord.MessageEmbed()
                    ...
                    .addField(
                      "Seçim: ",
                      "Lütfen 1 ile 5 arasından seç ve numarasını yaz"
                    )
                );
                ...
                try {
                  ...
                  console.error(err);
                  return msg.channel.send(
                    "Geçerli veya hiçbir sayı giirlmedi, şarkı seçimi iptal ediliyor."
                  );
                }
...
Lütfen 1 ile 10 arasından seç ve numarasını yaz
            ...
            try {
              ...
              console.error(err);
              return msg.channel.send(
                "Geçerli veya hiçbir sayı girilmedi, şarkı seçimi iptal ediliyor."
              );
            }
            const videoIndex = parseInt(response.first().content);
      ...
      if (!msg.member.voice.channel)
        return msg.channel.send("Bir ses kanalında değilsin.");
      if (!serverQueue)
        return msg.channel.send("Atlayabileceğim bir şarkı çalmıyor.");
      ...
      if (!msg.member.voice.channel)
        return msg.channel.send("Bir ses kanalında değilsin.");
      if (!serverQueue)
        return msg.channel.send("Durdurabileceğim bir şarkı çalmıyor.");
      serverQueue.songs = [];
      ...
      if (!args[1])
        return msg.channel.send(`Şu anki ses: ${serverQueue.volume}`);
